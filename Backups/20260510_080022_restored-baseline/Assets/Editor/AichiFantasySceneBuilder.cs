...
namespace AichiFantasy.Editor
{
    public static class AichiFantasySceneBuilder
    {
        ...
        public static void RunStageExpansionSmokeTest()
        {
            ...
            if (!enemies.Contains("stage_boss_5") || !enemies.Contains("stage_enemy_15") || !enemies.Contains("impossible_one"))
        ...
        public static void MeasureGateArrivalTime()
        {
            ...
            string report = string.Format(
                "Gate arrival timing: estimated_player_time={0:0.0}min ({1:0}s), automated_runtime={2:0.00}s, scenes={3}, stage_events={4}, bosses={5}",
                seconds / 60.0,
                seconds,
        ...
        static void MakePortrait(string name, bool monster, int seed)
        {
            ...
            if (monster)
                DrawMonsterCutout(tex, seed, shade, main, gold);
            else
