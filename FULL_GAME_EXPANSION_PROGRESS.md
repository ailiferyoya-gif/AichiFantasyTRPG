...
## 2026-05-22 AltStore CI Polish
- バックアップ: `Backups/20260522_002940_pre_altstore_ci_polish`
- workflowにIPA/Source JSONの最低限の検査ステップを追加。
- Actions SummaryにBundle ID、Version、Build、AltStore Source URL、Direct IPA URLを表示するようにした。
- `IOS_ALTSTORE_BUILD.md` にSummary確認とSource JSON検査の説明を追記。
- ローカル確認: 対象ファイルの存在確認済み。iOS実ビルドとRelease公開はGitHub Actions上で確認する。
